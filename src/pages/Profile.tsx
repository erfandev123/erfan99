...
import { Settings, Grid, Bookmark, UserSquare, Link as LinkIcon, Heart, MessageCircle, PlaySquare, Play, ArrowLeft, Globe, MoreHorizontal, Send, CheckCircle2, UserPlus, X } from 'lucide-react';
          ...
          <div className="bg-white overflow-hidden mb-4 md:mb-6 relative p-4 md:p-6 flex flex-col items-center text-center">
            ...
            <div className="flex items-center justify-center space-x-6 md:space-x-10 mb-6 w-full">
              ...
              >
                ...
                <span className="text-gray-400 text-[11px] uppercase tracking-wider">Following</span>
              </div>
              <div 
              ...
              >
                ...
                <span className="text-gray-400 text-[11px] uppercase tracking-wider">Followers</span>
              </div>
              <div className="flex flex-col items-center cursor-pointer">
                <span className="text-lg font-bold text-gray-900">{totalLikes}</span>
                <span className="text-gray-400 text-[11px] uppercase tracking-wider">Likes</span>
              </div>
            </div>
            ...
            {savedPosts.map((post) => (
              ...
              >
                {(post.media && post.media.length > 0) ? (
                  post.type === 'reel' ? (
                    <video src={post.media[0]} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  ) : (
