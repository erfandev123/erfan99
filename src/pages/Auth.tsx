    ...
    <div className="min-h-screen w-full bg-gray-50 flex flex-col items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-[1000px] flex flex-col md:flex-row items-center justify-center md:space-x-12 lg:space-x-20">
        ...
        <div className="hidden md:flex flex-col max-w-[400px] mb-12 md:mb-0">
          <h1 className="text-6xl font-black tracking-tighter bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent italic drop-shadow-sm mb-4 select-none">
            Reeta
          </h1>
          <p className="text-2xl font-medium text-gray-900 leading-tight">
            Reeta helps you connect and share with the people in your life.
          </p>
        </div>
        ...
        <div className="w-full max-w-[350px] space-y-4">
          ...
          <div className="bg-white border border-gray-200 p-8 flex flex-col items-center shadow-sm rounded-sm">
            {/* Logo (Mobile Only) */}
            <h1 className="md:hidden text-4xl font-black tracking-tighter bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent italic drop-shadow-sm mb-8 select-none">
              Reeta
            </h1>
